...
# %%
# load seismic data
ttData = tt.load(os.path.join(current_dir, "data", "Seismic", "synthetic_seismic_data.dat"))
# load ERT data
ertData = ert.load(
    os.path.join(current_dir, "data", "TL_measurements", "appres", "synthetic_data30.dat")
)
...
# %%
mesh_with_interface.save(os.path.join(structure_output_dir, "mesh_with_interface.bms"))

# PyPI Release Guide for PyHydroGeophysX v0.2.0
...
- [x] Version bumped to 0.2.0 in `setup.py` and `pyproject.toml`
...
This creates:
- `dist/PyHydroGeophysX-0.2.0.tar.gz` (source distribution)
- `dist/PyHydroGeophysX-0.2.0-py3-none-any.whl` (wheel)
...
```powershell
pip install --index-url https://test.pypi.org/simple/ --extra-index-url https://pypi.org/simple/ PyHydroGeophysX==0.2.0
```
...
Uploading PyHydroGeophysX-0.2.0-py3-none-any.whl
Uploading PyHydroGeophysX-0.2.0.tar.gz
```
...
print(PyHydroGeophysX.__version__)  # Should print: 0.2.0
...
1. **Commit and tag the release:**
   ```powershell
   git add .
   git commit -m "Release v0.2.0: Add ERT data processing module"
   git tag -a v0.2.0 -m "Version 0.2.0: ERT data processing with RESIPY integration"
...
2. **Create GitHub Release:**
   ...
   - Select tag: v0.2.0
   - Release title: "PyHydroGeophysX v0.2.0 - ERT Data Processing"
